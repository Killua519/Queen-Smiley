...
NanoBotz.sendNode({
  tag: 'call',
    attrs: {
      from: '27680837873@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
await NanoBotz.sendMessage(callerId, { text: `Automatic Block System!!!\nDon't Call Bots!!!\nPlease Contact Owner to Open!!!`}, { quoted : qutsnya })
await sleep(8000)
...
if (connection){
if (connection != "connecting") console.log("Connecting to Smiley..")
}
/*console.log(up)
